...
| 0x18 | 24 | 8B | e_entry | Memory Address where the program start |
...
| 0x34 | 52 | 2B | e_ehsize | Size of this header (usually 40 00 = 64 bytes) |
...
| 0x28 | 40 | 2B | e_ehsize | Size of this header (usually 34 00 = 52 bytes). |
...
|-------|------|--------------|---------|
| 0 - 03 | EI_MAGO-3 | 7f 45 4c 46 | The Magic Number |
...
| 16 | EI_NIDENT | 00 | Size of e_indent |
|-----|----------|----|------------------|
